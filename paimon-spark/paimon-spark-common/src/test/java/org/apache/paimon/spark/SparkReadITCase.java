...
public class SparkReadITCase extends SparkReadTestBase {
    ...
    public void testCreateTableAs() {
        ...
        Path path = new Path(warehousePath, "default.db/partitionedTableAs");
        ...
        path = new Path(warehousePath, "default.db/testTableAs");
        ...
        path = new Path(warehousePath, "default.db/t_pk_as");
        ...
        path = new Path(warehousePath, "default.db/t_all_as");
    ...
    public void testShowCreateTable() {
        ...
        Path path = new Path(warehousePath, "default.db/tbl");
