...
public class BinaryRowTest {
    ...
    public void testVariant() {
        ...
        writer.writeVariant(0, Variant.fromJson("{\"age\":27,\"city\":\"Beijing\"}"));
        writer.setNullAt(1);
        writer.complete();
    ...
    public void testVariantArray() {
        ...
        arrayWriter.writeVariant(0, Variant.fromJson("{\"age\":27,\"city\":\"Beijing\"}"));
        arrayWriter.setNullAt(1);
        arrayWriter.writeVariant(2, Variant.fromJson("{\"age\":27,\"city\":\"Hangzhou\"}"));
        arrayWriter.complete();
