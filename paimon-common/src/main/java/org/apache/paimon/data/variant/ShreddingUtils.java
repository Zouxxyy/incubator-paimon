...
public class ShreddingUtils {
    ...
    public static Variant rebuild(ShreddedRow row, VariantSchema schema) {
        ...
        // todo(variant): support null
        if (false) {
            // The variant is unshredded. We are not required to do anything special, but we can
            // have an
    ...
    private static void rebuild(
            ShreddedRow row, byte[] metadata, VariantSchema schema, VariantBuilder builder) {
