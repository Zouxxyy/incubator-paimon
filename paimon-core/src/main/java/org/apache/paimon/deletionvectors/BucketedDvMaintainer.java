...
public class BucketedDvMaintainer {
    ...
    @Nullable private IndexFileMeta restoredDvFile;
    ...
    private BucketedDvMaintainer(
        ...
        this.modified = false;
        this.restoredDvFile = restoredDvFile;
    }
    ...
    public Pair<IndexFileMeta, IndexFileMeta> writeDeletionVectorsIndex() {
        if (modified) {
            ...
            IndexFileMeta toRemove = restoredDvFile;
            restoredDvFile = newIndexFile;
        ...
        public BucketedDvMaintainer create(
            ...
            if (restoredFiles.size() > 1) {
                throw new UnsupportedOperationException(
                        "One bucket should only have one dv file at most.");
            }
