...
public class KeyValueFileReaderFactory implements FileReaderFactory<KeyValue> {
    ...
    public static class Builder {
        ...
        public Builder withRequiredKeyType(RowType requiredKeyType) {
            this.requiredKeyType = requiredKeyType;
            return this;
        }

        public Builder withRequiredValueType(RowType requiredValueType) {
        ...
        public RowType requiredValueType() {
        ...
        public KeyValueFileReaderFactory build(
            ...
            RowType readKeyType = projectKeys ? this.requiredKeyType : keyType;
            ...
            return new KeyValueFileReaderFactory(
                    ...
                    new BulkFormatMappingBuilder(
                            formatDiscover, requiredTableFields, fieldsExtractor, filters),
