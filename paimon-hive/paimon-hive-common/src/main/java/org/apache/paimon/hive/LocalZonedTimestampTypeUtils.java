...
public class LocalZonedTimestampTypeUtils {
    ...
    public static boolean isHiveCompatibleTimestampType(TypeInfo hiveTypeInfo) {
        return isHiveLocalZonedTimestampType(hiveTypeInfo)
                || TypeInfoFactory.timestampTypeInfo.equals(hiveTypeInfo);
    }
}
